...
void detKeypointsShiTomasi(vector<cv::KeyPoint> &keypoints, cv::Mat &img, std::string imgPath, bool bVis)
{
...
void detKeypointsHarris(std::vector<cv::KeyPoint> &keypoints, cv::Mat &img, std::string imgPath, bool bVis)
{
...
// Detect keypoints using varios modern detectors
void detKeypointsModern(std::vector<cv::KeyPoint>& keypoints, cv::Mat& img, std::string detectorType, std::string imgPath, bool bVis)
{
